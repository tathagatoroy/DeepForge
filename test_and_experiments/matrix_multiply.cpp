...
#include <device_launch_parameters.h>  // For CUDA-specific built-in variables


#define BLOCK_SIZE 32  // Define the size of CUDA thread blocks
...
// Initialize a matrix with random floating-point values
